...
df = pd.read_csv("NLP/NLP-Miuul/datasets/amazon_reviews.csv", sep=",")
df.head()

###############################
# Normalizing Case Folding : buyuk kucuk harf yapma
###############################

df['reviewText'] = df['reviewText'].str.lower()

###############################
# Punctuations : Noktalama isaretleri
###############################

df['reviewText'] = df['reviewText'].str.replace('[^\w\s]', '')

# regular expression arastır
...
# en sonda join ile boşluklara göre birlestirme olucak
# ilk önce gelen ifade stringe cevrilmis str. ile bu olmadan da calısabilir garanti olsun diye
# split ile boşluklara göre kelimeyi split edicek parcalara ayıracak kelimeler tek tek kalmıs olcak
# for ile kelimeler arasında gez diyoruz
# gezdigin kelimeler sw icinde yoksa x olarak yaz diyoruz


###############################
# Rarewords  : nadir olarak geçen kelimeler
###############################
...
###############################
# Tokenization : cumleleri parcalamak demektir
###############################
...
# kelimelere göre programatik bir sekilde parcalama islemi
...
# frekansı 500 den yuksek olanları görsellestiriyoruz
